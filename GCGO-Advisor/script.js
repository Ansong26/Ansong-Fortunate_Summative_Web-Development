...
const questions = [('single', 'Which community challenge would you most like to work on?', ['Access to quality learning', 'Healthy communities', 'Climate resilience', 'Equal opportunities for women and girls'], [0, 1, 2, 3]), ('single', 'Which project sounds most meaningful?', ['Peer tutoring platform', 'Community health campaign', 'Plastic reduction initiative', "Girls' leadership programme"], [0, 1, 2, 3]), ('single', 'What kind of impact motivates you?', ['Helping people learn', 'Improving wellbeing', 'Protecting ecosystems', 'Expanding voice and opportunity'], [0, 1, 2, 3]), ('single', 'Which issue would you research for a semester?', ['Digital learning access', 'Preventive health', 'Climate adaptation', 'Gender equity'], [0, 1, 2, 3]), ('single', 'Which role sounds most like you?', ['Mentor and educator', 'Health advocate', 'Environmental organiser', 'Inclusion champion'], [0, 1, 2, 3]), ('hotspot', 'Hotspot: click the SDG area you would prioritise on a community map.', ['School', 'Clinic', 'Green zone', 'Community leadership'], [0, 1, 2, 3]), ('video', 'Video scenario: a community needs support. Which intervention would you prioritise?', ['Learning resources', 'Health outreach', 'Climate action', "Women's participation"], [0, 1, 2, 3]), ('single', 'What would you most like to change through your work?', ['Knowledge and opportunity', 'Health outcomes', 'Environmental behaviour', 'Power and representation'], [0, 1, 2, 3])];
const categories = ['Education', 'Health', 'Climate Change', 'Women Empowerment'];
